...
async def get_thumb(videoid):
    ...
    try:
        ...
        bold_font = ImageFont.truetype("ShrutixMusic/assets/font.ttf", 33)

        # Top-right "text"
        text_size = draw.textsize("GOVO BOTS    ", font=font)
        draw.text((1280 - text_size[0] - 10, 10), "GOVO BOTS    ", fill="yellow", font=font)
